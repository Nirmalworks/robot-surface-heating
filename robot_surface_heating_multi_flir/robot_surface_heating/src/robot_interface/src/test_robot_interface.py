...
class RobotInterfaceNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.desired_temperature = 60.0 # Celsius, = 140 Fahrenheit
        self.threshold_temperature = 70.0 # Celsius, = 158F
    ...
    def hottest_pose_callback(self, msg: Extrema):
        """If the hottest temperature is too hot, prompt robot
        to return to home position until surface has cooled down."""
        if msg.value > self.threshold_temperature:
    ...
    def heating_control_loop(self):
        ...
        try:
            ...
            if coldest_pose.value > self.desired_temperature or not self.homed_init or self.overheating:
