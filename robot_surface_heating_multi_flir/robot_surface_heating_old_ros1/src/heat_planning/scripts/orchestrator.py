...
class orchestrator:
    def __init__(self):
        self.heated_state_pub = rospy.Publisher('heated_state', Int32MultiArray, queue_size=1)
        self.heat_command_to_control_pub = rospy.Publisher('heat_command_control', Int32MultiArray, queue_size=1)
        self.heat_command_sub = rospy.Subscriber('heat_command', Int32MultiArray, self.heated_command_callback,queue_size=1)
