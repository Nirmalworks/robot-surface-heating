...
def capture_calibration_images(img, step, output_dir='calibration_images'):
...
def calibrate_camera_from_images(calibration_dir='calibration_images'):
    """
      ...
      try:
        while True:
          ...
          # if step > 0:
            ...
            mtx, dist, res = calibrate_camera_from_images(img_dir)
            print(mtx, dist, res)
          ...
          img = raw_to_8bit(data)
          status, corners = capture_calibration_images(img, step, output_dir=img_dir)
          if status:
